...
public class DownloadHistoryListAdapter extends BaseAdapter {

	private ArrayList<HashMap<String[], Bitmap>> listData;
	private Context context;

	public DownloadHistoryListAdapter(Context context, ArrayList<HashMap<String[], Bitmap>> listData) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.uploadtime.setText("下载时间:"+listData.get(position).keySet().iterator().next()[2]);
		return convertView;
	}
